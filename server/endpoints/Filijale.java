...
public class Filijale {
    ...
    public String napraviFilijalu(@PathParam("naziv") String naziv, @PathParam("adresa") String adresa, @PathParam("idMes") int idMes) {
    ...
    public String dohvatiFilijale() {
        ...
        if(msg instanceof ObjectMessage) {
            try {
                ...
                ArrayList<Filijala> filijale = (ArrayList<Filijala>)objMsg.getObject();
                String response = "";
